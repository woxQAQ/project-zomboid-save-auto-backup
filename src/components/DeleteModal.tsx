  ...
  return (
    ...
    >
      <div className="bg-gray-900 border border-gray-700 rounded-lg shadow-2xl max-w-md w-full">
        ...
        {/* Body */}
        <div className="p-6" id="delete-modal-description">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded p-4 mb-4">
            <p className="text-sm text-gray-400 mb-1">Backup to delete:</p>
          ...
          {/* Warning */}
          <div className="flex items-start space-x-3 bg-red-900/20 border border-red-900/50 rounded p-3">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
            ...
            <div>
              <p className="text-sm text-red-200 font-medium">Destructive action</p>
              <p className="text-xs text-gray-400 mt-1">
                Once deleted, this backup will be permanently removed and cannot be recovered.
              </p>
            </div>
          </div>
        </div>
